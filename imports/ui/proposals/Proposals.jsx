...
export default class Proposals extends Component{
    ...
    render() {
        return <div>
            <Helmet>
                <title>Governance Proposals on {Meteor.settings.public.chainName} | CHIMBA</title>
                <meta name="description" content="{Meteor.settings.public.chainName} incorporates on-chain governance. Come to see how on-chain governance can be achieved on CHIMBA." />
            </Helmet>
            <Row>
